...
class TestPadding:
    def test_padding_uses_high_order_eos_bits(self):
        ...
        # Actually per HUFFMAN_TABLE[32] = (0x14, 6), so bits = 0b010100, pad 2 → 0b01010011 = 0x53
    ...
    def test_invalid_padding_zero_bits_raises(self):
        ...
        # Per HUFFMAN_TABLE[97] = (0x3, 5): bits = 0b00011
